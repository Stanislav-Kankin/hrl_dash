...
class BitrixAPI {
    ...
    static async makeRequest(url, options = {}) {
        try {
            ...
            console.log('🔐 Endpoint check:', { url, isPublicEndpoint, hasToken: !!this.authToken });
            ...
            console.log('🔐 Making request to:', url, 'with auth header:', !!defaultOptions.headers['Authorization']);
